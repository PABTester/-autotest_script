...
def get_log(log_model_name, style='file'):
    ...
    all_log_path = os.path.join(path, 'D:\Rabp\logs\All_Logs\\')

    error_log_path = os.path.join(path, 'D:\Rabp\logs\Error_Logs\\')
...
if __name__ == '__main__':
    ...
    logger0 = get_log('rabp', 'console')  # test需要打印日志的项目名称

    logger0.info('1213' + '232')
